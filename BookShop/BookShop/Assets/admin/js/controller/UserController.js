var user = {
    ...
    registerEvents: function () {// method để ghi sự kiện
        ...
        $('.btn-active').off('click').on('click', function (e) {
            e.preventDefault();//dể reset

            var btn = $(this);
            var id = $(this).data('id');//lấy ra tất cả thuộc tính mà đằng trước nó là data và sau nó là id, hoặc có thể dùng Prop('id') đều đc, id nằm trong data-id của nút mình bấm vào
            //Gọi Ajax
            $.ajax({
