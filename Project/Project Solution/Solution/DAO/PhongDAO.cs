//Quản lý phòng
//Author:Lê Trung Hiếu: quản lý phòng, Đậu thị Thanh Huyền: Tìm phòng
using System;
...
namespace DAO
{
    public class PhongDAO
    {
        ...
        // lấy các phòng còn trống theo loại phòng 
        ...
        // lấy số lượng phòng trống theo loại phòng
        ...
        // lấy danh sách các phòng trả gần nhất
        ...
        {
            var query = (from r in context.PHONGs
                         join t in context.LOAI_PHONG on r.LOAI_PHONG.MaLoaiPhong 
                         equals t.MaLoaiPhong
                         select new PhongDTO
                         {
                             MaPhong = r.MaPhong,
                             TinhTrang = r.TinhTrang,
        ...
        //Lấy danh sách phòng theo tìm kiếm
